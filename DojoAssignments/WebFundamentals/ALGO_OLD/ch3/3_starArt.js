...
// You should print the given number of asterisks consecutively. Depending on which function is called, 
// those stars should be left-justified (the first star would be very first character in the text field), 
// or right-justified (last star would be very last character in the text field, with potentially some 
// number of spaces at the beginning of the text field before the block of stars start), or centered 
// in the 75 -character text field (with the same number of spaces on either side of the block of stars,
// plus/minus one).
...
// The stars should build from the right side. the last num characters should be asterisks; 
